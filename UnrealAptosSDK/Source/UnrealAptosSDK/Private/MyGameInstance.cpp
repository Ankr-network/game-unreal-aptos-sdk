...
{
	GEngine->AddOnScreenDebugMessage(1, 3.0f, FColor::Red, *FString("UMyGameInstance::OnApplicationResumed"));
	UE_LOG(LogTemp, Warning, TEXT("UMyGameInstance::OnApplicationResumed"));
}
